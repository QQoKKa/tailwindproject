...
import {getFirestore, collection, getDocs, addDoc, deleteDoc, doc, updateDoc,setDoc,where
...
export {db, collection, getDocs, addDoc, deleteDoc, doc, updateDoc,setDoc,where};